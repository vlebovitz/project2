...
#aggregate the chest pain type by total number in dataset
heartDataset.filter(['ChestPainType','Heart_Disease']).query('Heart_Disease == "yes"').groupby(['ChestPainType']).agg(['size'])
# 
# def positivePatients(dataSet):
#   count = 0
#   for i in dataset.HeartDisease:
#     if(i==1):
#       count += 1
#   return count
# 
# print(positivePatients(heartDataset))
# 
